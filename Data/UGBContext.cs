...
public partial class UGBContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) =>
        optionsBuilder.UseSqlServer(
            "Server=localhost;Database=UGB;Trusted_Connection=True;TrustServerCertificate=true;"
        );
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<EntradaEstoque>(entity =>
        {
            ...
            entity
                .Property(e => e.EntradaDeposito)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("entrada_deposito");
            entity
                .Property(e => e.EntradaNf)
                .HasMaxLength(45)
                .IsUnicode(false)
        ...
        modelBuilder.Entity<OrdemCompra>(entity =>
        {
            entity
                ...
                {
                    e.OrdemId,
                    e.PedidoInternoPedidoId,
                    e.PedidoInternoUsuarioUserMat
                })
            ...
            entity
                .Property(e => e.PedidoInternoUsuarioUserMat)
                .HasColumnName("Pedido_Interno_Usuario_user_mat");
            entity
                .Property(e => e.OrdemPrecototal)
        ...
        {
            entity
                .HasKey(e => new { e.PedidoId, e.UsuarioUserMat })
        ...
        modelBuilder.Entity<Produto>(entity =>
        {
            ...
            entity.Property(e => e.ProdEan).ValueGeneratedNever().HasColumnName("prod_ean");
            entity
                .Property(e => e.ProdEstoqueminimo)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("prod_estoqueminimo");
            entity
                .Property(e => e.ProdFabricante)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("prod_fabricante");
            entity
                .Property(e => e.ProdNome)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("prod_nome");
            entity
                .Property(e => e.ProdPreco)
                .HasMaxLength(45)
                .IsUnicode(false)
        ...
        {
            entity
                .HasKey(e => new { e.ServId, e.FornecedorFornecedorCnpj })
            ...
            entity
                .Property(e => e.FornecedorFornecedorCnpj)
                .HasColumnName("Fornecedor_fornecedor_CNPJ");
            entity.Property(e => e.ServDescricao).IsUnicode(false).HasColumnName("serv_descricao");
            entity
                .Property(e => e.ServNome)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("serv_nome");
            entity
                .Property(e => e.ServPrazo)
                .HasMaxLength(45)
                .IsUnicode(false)
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.Property(e => e.UserMat).ValueGeneratedNever().HasColumnName("user_mat");
            entity
                .Property(e => e.UserDepartamento)
                .HasMaxLength(45)
                .IsUnicode(false)
            ...
            entity
                .Property(e => e.UserNome)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("user_nome");
            entity
                .Property(e => e.UserSenha)
                .HasMaxLength(45)
                .IsUnicode(false)
